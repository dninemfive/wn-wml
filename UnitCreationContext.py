...
class UnitCreationContext(object):
    ...
    def add(self: Self):
        ...
        with Message(f'Adding {self.internal_name}') as msg:
            with self.edit(msg, r'GameData\Generated\Gameplay\Gfx\UniteDescriptor.ndf', padding) as unite_descriptor_ndf:
                unite_descriptor_ndf.add(ListRow(self.object, namespace=self.descriptor_name))
            # add unit to ShowRoomEquivalence.ndf
            with self.edit(msg, r'GameData\Generated\Gameplay\Gfx\ShowRoomEquivalence.ndf', padding) as showroom_equivalence_ndf:
            ...
            with self.edit(msg, r'GameData\Generated\Gameplay\Decks\DivisionPacks.ndf', padding) as division_packs_ndf:
            ...
            with self.edit(msg, r"GameData\Generated\Gameplay\Decks\DeckSerializer.ndf", padding) as deck_serializer_ndf:
            ...
            with self.edit(msg, r"GameData\Generated\Gameplay\Gfx\AllUnitsTactic.ndf", padding) as all_units_tactic_ndf:
